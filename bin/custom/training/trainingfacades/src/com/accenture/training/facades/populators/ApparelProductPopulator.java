 ...
 */
package com.accenture.training.facades.populators;
...
import com.accenture.training.facades.product.data.GenderData;
...
public class ApparelProductPopulator implements Populator<ProductModel, ProductData>
{
	...
	public void populate(final ProductModel source, final ProductData target) throws ConversionException
	{
		...
		if (baseProduct instanceof ApparelProductModel)
		{
			...
			target.setWebLabel(apparelProductModel.getWebLabel());
